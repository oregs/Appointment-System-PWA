...
export default {
  ...
  data() {
    return {
      ...
      activeAppointmentId: '',
      service_categories: [
        { id: 1, category: 'Hair Dressing' },
        { id: 2, category: 'Barbing Saloon' },
      ],
      service_types: [
          { id: 1, service_category_id: 1, type: 'Ghana Weaving' },
          { id: 2, service_category_id: 1, type: 'Shuku' },
          { id: 3, service_category_id: 2, type: 'Obama Cut' },
      ],
      activeServiceTypes: [],
      branches: [
        { id: 1, name: 'Agege' },
