                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form @submit.prevent="handleSubmit()" class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div class="flex items-center justify-end">
                            ...
                            <router-link to="/forgot-password" class="text-sm font-medium text-center text-primary-600 hover:underline dark:text-primary-500">Forgot password?</router-link>
                        </div>
