    ...
    <div>
        <nav class="flex items-center justify-between px-4 py-4 pt-4 pagination-row" aria-label="Table navigation">
            ...
            <ul class="inline-flex items-center -space-x-px">
                ...
                <li v-for="(item, index) in new Array(pages)" :key="index">
                    <a href="#" class="pagination-button px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">{{ index + 1 }}</a>
                </li>
                <!-- <li>
